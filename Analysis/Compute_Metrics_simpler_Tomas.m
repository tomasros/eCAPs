...
function [TPM,Counts,Number,Avg_Duration,Duration,TM,From_Baseline,...
    ...
    Compute_Metrics_simpler_Tomas(idx,xindp1,sind,n_clusters,TR)
    ...
    [Counts,Duration,Number,Avg_Duration,TM] = CAP_ComputeMetrics_Tomas(TPM,n_clusters+1,TR,n_frames);
