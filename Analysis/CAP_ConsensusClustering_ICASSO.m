...
function [meanIq] = CAP_ConsensusClustering_ICASSO(X,K_range,Subsample_type,Subsample_fraction,n_folds,DistType)



%%Tomas ICASSO resampling (alternative to consensus clustering)

meanIq=eCAPS_Tomas_kmeans_ICASSO(X, min(K_range), max(K_range), n_folds, Subsample_fraction, 20);
